IPEmotionRTSettings COM Reference
...
IPEmotionRTSettings Interfaces Overview . . . . . . . . . . . . . . . . . . . . . . . . . . . . .

IPEmotionRTSettings Namespace Index
IPEmotionRTSettings Namespace List

3.1

. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .

IPEmotionRTSettings Hierarchical Index

4.1

IPEmotionRTSettings Interface Hierarchy . . . . . . . . . . . . . . . . . . . . . . . . . . . . .

IPEmotionRTSettings Interface Index

5.1

IPEmotionRTSettings Interface List . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .

IPEmotionRTSettings Namespace Documentation

6.1

IPEmotionRTSettings Namespace Reference . . . . . . . . . . . . . . . . . . . . . . . . . . .

IPEmotionRTSettings Interface Documentation
...
This manual describes the COM interface provided by the software IPEmotionRTSettings.
...
This document describes the COM interfaces of the IPEmotionRTSettings program.

The IPEmotionRTSettings program is meant to be used to modify the IPEmotionRT options.

The program can only be used, while no instance of IPEmotionRT is running. Only one instance of this pro-
gram can be run simultaneously. It will only change the options of the latest installed version of IPEmotionRT.

To change the IPEmotionRT options, you need to write a script or program, that uses the COM interface,
provided by the IPEmotionRTSettings program.

The actual options are loaded at program startup and will be changed only if the interface function SaveSet-
tings() is called.

The IPEmotionRTSettings program must be terminated by calling the interface function Quit(), before IPEmo-
tionRT will be started.

2.1 IPEmotionRTSettings Interfaces Overview

Namespace IPETRONIK.IPEmotionRTSettings
...
3.1 IPEmotionRTSettings Namespace List

The following chapter lists all namespaces with brief descriptions:

IPEmotionRTSettings (Namespace of the IPEmotionRT settings interface) . . . . . . . . . . . . . . .
...
4.1 IPEmotionRTSettings Interface Hierarchy
...
5.1 IPEmotionRTSettings Interface List
...
ISettingsHandler (IPEmotionRT settings handler interface) . . . . . . . . . . . . . . . . . . . . . . . .
...
IPEmotionRTSettings Namespace
Documentation

6.1 IPEmotionRTSettings Namespace Reference

Namespace of the IPEmotionRT settings interface.
...
IPEmotionRT settings handler interface.
...
• 0: Legacy - display in the same way as in IPEmotionRT 2019R1 and earlier
...
Returns or sets whether IPEmotionRT loads the last used configuration on start.

• bool HardwareDetectionOnStart [get, set]

Returns or sets whether IPEmotionRT starts a hardware detection on start.
...
detection on IPEmotionRT start.
...
Returns or sets whether diagnostic job sequences are displayed in the IPEmotionRT setup tree and diagnostic
jobs in the grid.
...
Returns or sets the localization of the IPEmotionRT UI.

• string Skin [get, set]

Returns or sets the name of the skin to be used by the IPEmotionRT UI.
...
Specifies whether the Windows standard file open/save dialog is user or the IPEmotionRT specific variant.

• bool TimeChannelIsAbsolut [get, set]

Specifies whether the IPEmotionRT time channels are displayed in relative time or absolute time.
...
Specifies the default directory where IPEmotionRT loads and stores script files.
...
Returns whether IPEmotionRT will load configurations that were created with a newer version of IPEmotionRT.
...
Returns or sets the way IPEmotionRT will display the entries in the measurement data tree.
...
Specifies which color coding IPEmotionRT should use for thermocouple information.
...
licenseKey Lizense key to be assigned. IPEmotionRT will use this license when it’s started.
...
For IPEmotionRT only values from 1048576 (1 MByte) up to 1073741824 (1 GByte) are allowed.
...
Specifies whether the user can modify the IPEmotionRT status.
...
enabbleStatusModification Specifies whether the new user may change the IPEmotionRT satus.
IPETRONIK GmbH & Co. KG
